...
def dfm(X,Spec,threshold = 1e-5,max_iter = 5000):
    ...
    A,C,Q,K,R,Z_0,V_0  = InitCond(xNaN.copy(), r.copy(), p, blocks.copy(), optNaN, R_mat.copy(), q, nQ, i_idio.copy())
    ...
    while num_iter < max_iter and not converged: # Loop until converges or max iter.
        ...
        C_new, R_new, A_new, Q_new, K_new, Z_0, V_0, loglik = EMstep(y_est, A, C, Q, K, R, Z_0, V_0, r,p,R_mat,q,nQ,i_idio,blocks)
...
def InitCond(x,r,p,blocks,optNaN,Rcon,q,nQ,i_idio):
    ...
    return A, C, Q, K, R, Z_0, V_0

def EMstep(y, A, C, Q, K, R, Z_0, V_0, r,p,R_mat,q,nQ,i_idio,blocks):
